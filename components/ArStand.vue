<template>
  <div class="clr-mono1 medium-normal-text wrapper">
    <div class="item item1">
      ...
      <div
        class="prg1"
      >Элементами управляющего интерфейса стенда являются кубики, комбинация которых на стенде сопровождается звуковым или графическим эффектом.</div>

      <div class="prg1">
        <div class="highlight clr-blue2 prg4">Какие навыки будут развиты</div>
        <ul>
    ...
    <div class="item item3">
      <div class="prg2">
        <div class="highlight clr-blue2 prg4">На кого рассчитан проект</div>
        <div>AR-Stand будет полезен в двух случаях:</div>
      </div>
      ...
      <div class="prg2">
        ...
        <ul>
          ...
          <li class="star">Машинное обучение</li>
        </ul>
      </div>
    </div>
  </div>
